...
if __name__ == "__main__":
    ...
    test_reduce_tensor_Levi_Civita_symbol(1e-4)
    print("test_reduce_tensor_antisymmetric_L2")
    test_reduce_tensor_antisymmetric_L2(1e-4)
    print("test_reduce_tensor_elasticity_tensor")
    test_reduce_tensor_elasticity_tensor(1e-4)
    print("test_reduce_tensor_elasticity_tensor_parity")
    test_reduce_tensor_elasticity_tensor_parity(1e-4)
